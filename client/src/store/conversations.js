...
export const setNewMessage = (message, userId, activeConversation, sender) => {
  return {
    type: SET_MESSAGE,
    payload: { message, userId, activeConversation: activeConversation || null, sender: sender || null },
  };
};
